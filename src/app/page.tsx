...
// Type for icon component (LucideIcon or custom component)
...
const StepCard = ({
  ...
  <motion.div
    variants={fadeIn}
    className="relative flex flex-col items-center text-center p-6 rounded-xl bg-card/30 backdrop-blur-sm border border-primary/10"
  >
    <div className="absolute -top-4 -left-4 bg-primary text-primary-foreground w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm">
      {number}
    </div>
    <div className="p-3 rounded-full bg-primary/10 mb-4">
      <Icon className="h-8 w-8 text-primary" />
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
            ...
            <motion.div variants={fadeIn} className="mt-16 relative">
              <div className="relative bg-card/30 backdrop-blur-sm border border-primary/10 rounded-2xl p-8 w-full max-w-2xl mx-auto">
                <div className="absolute -top-6 left-1/2 -translate-x-1/2">
                  <TrustScore value={92} size="lg" label="Example TrustScore" />
                </div>
                <div className="h-32" />
                <div className="grid grid-cols-3 gap-4 text-center pt-4">
                  <div>
                    <h4 className="text-sm text-muted-foreground">Technical</h4>
                  ...
                  <div>
                    <h4 className="text-sm text-muted-foreground">Activity</h4>
      ...
      {/* Features Section */}
      <section id="features" className="py-15 bg-background">
        <div className="container mx-auto px-4">
          <motion.div
          ...
          >
            ...
            >
              TrustScore combines AI-powered analysis with blockchain technology
              to create verifiable credentials you can trust.
            </motion.p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.p
              ...
              className="text-muted-foreground max-w-2xl mx-auto"
            >
              Get your TrustScore in four simple steps and start building trust
